    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String date = dateTextView.getText().toString(); // Get the selected date
                String time = timeTextView.getText().toString(); // Get the selected time
                ...
                if (finalIsUpdate) {
                    ...
                    task.setTask(text);
                    task.setStatus(0);
                    task.setDate(date); // Set the selected date
                    task.setTime(time); // Set the selected time
                    db.insertTask(task);
                }
                dismiss();
            }
